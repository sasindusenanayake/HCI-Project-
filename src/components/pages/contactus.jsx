            ...
            <div className="cmain" style={{background: 'url( https://cdn.wallpapersafari.com/64/92/uMUbRo.jpg)' }}>   
                <div className="contact">
                    ...
                    <div className="form">
                        ...
                        <input type="text"   name="address" id="txt_address" className="t3"/><br/>

                        <label><font color="white">City :</font></label><br/>
                        <input type="text"   name="city" id="txt_city" className="t4"/><br/>

                        <label><font color="white">Zip Code :</font></label><br/>
                        <input type="text"   name="zip" id="txt_zip" className="t5"/><br/>

                        <label><font color="white">Email Address :</font></label><br/>
                        <input type="text"   name="email" id="txt_email" className="t6"/><br/>

                        <label><font color="white">Phone number :</font></label><br/>
                        <input type="text"   name="phone" id="txt_phone" className="t7"/><br/>
