		   ...
		   <form method="post" action="/">
			<div>
		      <label for="companyname">
		      	...
		      	<input type="text" id="companyname" name="companyname" value="" placeholder="Company Name" required="required" tabindex="1" autofocus="autofocus" />
		      </label> 
			</div>
            ...
            <div>
		      <label for="ownername">
		      	...
		      	<input type="text" id="ownername" name="ownername" value="" placeholder="Owner Name" required="required" tabindex="1" autofocus="autofocus" />
		      </label> 
			</div>
            ...
            <div>
		      <label for="Address">
		      	...
		      	<input type="text" id="Address" name="Address" value="" placeholder="Address" required="required" tabindex="1" autofocus="autofocus" />
		      </label> 
			</div>
            ...
            <div>
		      <label for="phone">
		      	...
		      	<input type="text" id="phone" name="phone" value="" placeholder="phone number" required="required" tabindex="1" autofocus="autofocus" />
		      </label> 
			</div>
