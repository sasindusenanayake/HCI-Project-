...
import ImageG from '../../asserts/gatesiamges/gates.jpg'
    ...
    render() {
        return (
            <div>
                ...
                <div className="col-md-6" style={{background: 'url(https://stargateuk.net/wp-content/uploads/2018/10/Bi-folding-gates.jpg) no-repeat center center', backgroundSize: 'cover'}}>
